...
- Claude Code
- Gemini CLI
- M365 Copilot (Windows)

More agents coming soon. The architecture is designed for extensibility (adding custom agent definitions is relatively straightforward).
...
> For detailed installation instructions including development installs, native builds, cross-compilation, and deployment options, see the [full documentation](https://originsec.github.io/praxis/).
...
We recommend providers with fast inference like **Groq** or **Cerebras** for the parser features. But don't select any model too basic - needs to be capable of performing the parsing tasks.
