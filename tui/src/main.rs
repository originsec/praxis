...
#[command(
    about = "Praxis terminal UI with a small non-interactive CLI surface",
    after_help = "Without an action flag or subcommand, praxis_tui starts the TUI.\n\nExamples:\n  praxis_tui\n  praxis_tui --rabbitmq amqp://praxis:praxis@localhost:5672\n  praxis_tui --status\n  praxis_tui -C \"node list\"\n  praxis_tui session create --node abc123 --yolo"
)]
#[command(version)]
struct Cli {
    /// RabbitMQ URL
...
#[derive(Parser)]
#[command(name = "praxis_tui", no_binary_name = true)]
