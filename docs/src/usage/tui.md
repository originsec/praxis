...
This page covers the interactive UI. For scripting, one-shot commands, and
global options, see [CLI](./cli.md).
...
under [CLI — Traffic Interception](./cli.md#available-commands).
