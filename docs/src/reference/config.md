...
| `claude_ccrv1_port` | `8587` | Port for CCRv1 WebSocket connections |
| `claude_ccrv2_enabled` | `false` | Enable the CCRv2 (HTTP+SSE) bridge listener |
| `claude_ccrv2_port` | `8588` | Port for CCRv2 HTTP connections |
...
| Claude Bridge CCRv1 | 8587 | WS |
| Claude Bridge CCRv2 | 8588 | HTTP |
| RabbitMQ | 5672 | AMQP |
