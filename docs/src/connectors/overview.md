...
Not all agents support all features. The core capabilities - fingerprinting, traffic interception, recon (config/tools/sessions discovery), and sessions - are supported by most connectors. However, some features depend on how the agent works:
